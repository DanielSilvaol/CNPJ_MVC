...
namespace CNPJ_MVC.Migrations
{
    ...
    [Migration("20190824135949_Alterar2")]
    partial class Alterar2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CNPJ_MVC.Models.AtividadePrincipal", b =>
                {
                    b.HasOne("CNPJ_MVC.Models.Empresa", "Empresa")
            ...
            modelBuilder.Entity("CNPJ_MVC.Models.Empresa", b =>
                {
                    b.HasOne("CNPJ_MVC.Models.Billing", "billing")
                        .WithOne("Empresa")
                        .HasForeignKey("CNPJ_MVC.Models.Empresa", "billingid")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("CNPJ_MVC.Models.Extra", "extra")
                        .WithOne("Empresa")
                        .HasForeignKey("CNPJ_MVC.Models.Empresa", "extraid")
                        .OnDelete(DeleteBehavior.Cascade);
                });
